 ...
 */
let HomeController = class HomeController extends express_dependency_injection_1.AbstractRouter {
    /**
     * Enregistrement d'un foyer (maison)
     * @param _req Request
     * @param res Response
    ...
    post(_req, res, args) {
        ...
        newHome.setNameOfHome(args.body.nameOfHome);
        newHome.setGeolocallisationHome(args.body.geolocallisationHome);
        newHome.setSectorCode(args.body.sectorCode);
        return rxjs_1.from(this.repoHome.save(newHome)).subscribe(data => data != null ? res.json(data) : null, error => res.status(500).send({ message: 'la requête à été interompu : ' + error }), () => res.end());
    }
    /**
     * Retourne un foyer à partir de son id
     * @param _req Request
     * @param res Response
     * @param args Arguments
     */
    ...
    /**
     * Retourne la liste de toutes les residences
     * @param _req Request
     * @param res Response
     * @param args Arguments
     */
...
], HomeController.prototype, "repoHome", void 0);
__decorate([
