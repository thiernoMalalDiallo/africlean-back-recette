...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, session, alert) {
     ...
     * @param page page
     */
    HomePage.prototype.isSubscribe = function (page) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var role, isSubscribe;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.session.getItem('role')];
                    case 1:
                        role = _a.sent();
                        if (!(role === 'CLIENT')) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.session.getItem('isSubscribe')];
                    case 2:
                        isSubscribe = _a.sent();
     ...
     */
    HomePage.prototype.onDemandToSubscribe = function () {
        var _this = this;
        var message = 'Pour accèder à cette fonctionnalité, veuillez vous abonner.';
        var css = '';
        var buttons = [
            {
                text: 'S\'abonner',
                handler: function () {
                    _this.navCtrl.navigateForward('consult-abonnement');
                }
            }
        ];
