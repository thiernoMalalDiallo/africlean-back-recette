...
const abonnement = '../pages/abonnement/abonnement.module#AbonnementPageModule';
const incident = '../pages/incident/incident.module#IncidentPageModule';
const service = '../pages/service/service.module#ServicePageModule';
